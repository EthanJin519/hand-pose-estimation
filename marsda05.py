...
from marsda.model.regda_6 import PoseResNetx5 as RegDAPoseResNetx1, PoseResNetx6 as RegDAPoseResNetx2, RegressionDisparityx1, PseudoLabelGenerator01, refineNet3, RegressionDisparity
...
def main(args: argparse.Namespace):
  ...
  #  backbone2 = models.__dict__[args.arch2]()
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        # train for one epoch
        train(train_source_iter, train_target_iter, model, model_ema, refineNet, criterion, regression_disparity, regression_disparity2,
              optimizer_f, optimizer_h, optimizer_h_adv, optimizer_h_adv2, optimizer_refine, lr_scheduler_f, lr_scheduler_h, lr_scheduler_h_adv,
              lr_scheduler_h_adv2, lr_scheduler_refine, epoch, visualize if args.debug else None, args)
        ...
        torch.save(
            ...
            }, logger.get_checkpoint_path('model_ema')
        )
